...
public class Inventory implements InventoryHolder {
    ...
    public Inventory(Player owner, String name, int size) {
        this.owner = owner;
        this.name = name;
        this.size = size;
    ...
    public Inventory(Player owner, int size) {
        this(owner, "", size);
    }

    public Inventory(Player owner, String name, InventoryType inventoryType) {
        this(owner, name, inventoryType.getDefaultSize());
    }

    public Inventory(Player owner, InventoryType inventoryType) {
